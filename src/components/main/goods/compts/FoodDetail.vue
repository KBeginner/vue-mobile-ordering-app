      ...
      <div class="food-rating">
        <ul v-if="foodDetail.rating">
          ...
          <li class="comment-list" >
            <el-row>
              <el-col :span="4">
                <span><img :src="foodDetail.rating.comment_list[0].user_icon"/></span>
                <span>{{foodDetail.rating.comment_list[0].user_name}}</span>
              </el-col>
              <el-col :span="20">
                {{foodDetail.rating.comment_list[0].comment_content}}
              </el-col>
            </el-row>
          </li>
        </ul>
